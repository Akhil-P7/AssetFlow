...
export class AllocationsService {
  ...
  async requestTransfer(dto: any, actor: any) {
    /* TODO */ throw new Error('Not implemented');
  }
  ...
  async rejectTransfer(id: string, dto: any, actor: any) {
    /* TODO */ throw new Error('Not implemented');
  }
}
