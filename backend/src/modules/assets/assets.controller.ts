...
export class AssetsController {
  ...
  @Get('tag/:assetTag')
  findByTag(@Param('assetTag') tag: string) { return this.service.findByTag(tag); }

  @Post()
  @Roles('ADMIN', 'ASSET_MANAGER')
  create(@Body() dto: CreateAssetDto, @CurrentUser() user: any) { return this.service.create(dto, user); }
  ...
  @Roles('ADMIN', 'ASSET_MANAGER')
  @RefetchRole()
  transition(@Param('id') id: string, @Body() dto: any, @CurrentUser() user: any) {
    return this.service.transitionStatus(id, dto.toStatus, 'manual.override.' + dto.reason, user.role, dto.reason);
  }
}
